...
See [the report](docs/REPORT.md) for methods and measured results. This is an AI-generated reference project; the supplied course rules prohibit submitting AI-written code.
